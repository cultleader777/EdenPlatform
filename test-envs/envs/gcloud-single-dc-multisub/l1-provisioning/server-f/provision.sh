...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  ...
  "advertise_addr": "10.17.1.12",
  "advertise_addr_wan": "10.17.1.12",
  "auto_encrypt": {
    "tls": true
  },
  "bind_addr": "10.17.1.12",
...
bind_addr = "10.17.1.12"
advertise {
    http = "10.17.1.12:4646"
    rpc = "10.17.1.12:4647"
    serf = "10.17.1.12:4648"
}
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
kL+3uIFYCALD4EXVjgFtdabL0uhg2YzGHza1T+pR5UE=
LilBoiPeepLikesBenzTruck
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-f.dc1.us-west.gcloud-single-dc:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-f.dc1.us-west.gcloud-single-dc: \w\a\]\u@server-f.dc1.us-west.gcloud-single-dc:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-f.dc1.us-west.gcloud-single-dc:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
view lan {
    ...
    systemd.services.node_exporter = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${pkgs.prometheus-node-exporter}/bin/node_exporter" +
          ...
          " --web.listen-address=10.17.1.12:9100" +
    ...
    networking.interfaces.eth0.ipv4.addresses = [
      { address = "10.17.1.12"; prefixLength = 24; }
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"f17bcff169b97cb7418c98e6617ad96df98ae32252c5554f1506c0e3d70281f8\",hostname=\"server-f\"} $BOOT_TIME
" > $METRICS_FILE.tmp
