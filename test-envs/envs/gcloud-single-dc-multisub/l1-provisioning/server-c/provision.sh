...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  "acl": {
    ...
    "tokens": {
      ...
      "initial_management": "fca1e67e-b266-40fb-b394-98d7c76283f9"
    }
  },
  "addresses": {
    "dns": "127.0.0.1",
  ...
  "advertise_addr": "10.17.1.10",
  "advertise_addr_wan": "10.17.1.10",
  "auto_encrypt": {
    "allow_tls": true
  },
  "bind_addr": "10.17.1.10",
  "bootstrap": false,
  "bootstrap_expect": 3,
...
bind_addr = "10.17.1.10"
advertise {
    http = "10.17.1.10:4646"
    rpc = "10.17.1.10:4647"
    serf = "10.17.1.10:4648"
}
...
listener "tcp" {
  address = "10.17.1.10:8200"
  cluster_address = "10.17.1.10:8201"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
30UtMRf7AbniWgKowNx9U/6dvVf0TUxf85kcP6lkAug=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

GBZ4UR4CIFaP7Xnl32AKV37OQVqyFet2xwwYoslEgx+BHOD3RPzW
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEID2Z/rgGIjoaQRogcHTs0IrNHZcPt7MIfqjo6NMa+Ou8oAoGCCqGSM49
AwEHoUQDQgAEh9ApQuj/uO/mDVD4jL1YENqRyZeHGC+jr2Jh+OJH67NsPHU1ntw2
OF4doiwR4FUHjuQdD21d/MTtd2pjvpYOOw==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
fca1e67e-b266-40fb-b394-98d7c76283f9
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
8ba69b97-918b-4960-99cd-b5f6a9611a41
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
030b84b4-91d4-4553-8e84-87c767f6a652
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
1023ffa2-87cd-4098-9bde-77f37fb57a65
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
d6b78bd1-8b27-411e-a55b-7dd14aca05b5
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
b86e4f43-07a5-4145-9369-72f8c8a2864c
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
d10fbf1f-70c8-4e85-bdff-7187c2eaec91
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIhAIrO5fluH8Rs6eSb
Q6dv0uo1QhpielLxeqFDiGnaZ0rVAiBfBJRGACiUaLSQMX95cTpi1ZQIhHd3Z3/G
9xJdzyET0Q==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIEkZ+ZdKlZ1e/Xh2355a4X2AJsDC6ysX65RVhOLLv1eMoAoGCCqGSM49
AwEHoUQDQgAEbgMo2vVXSjQiXPM2IcpInVNQY/2PPyzh7MorNeDYCSfFyANog/oS
QD9bJhxSizpfesu5LmuM+jUrHuc5Axe0oA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
wPSQDogiNzzJqmffz+TZr9Sho+5DCwSU3A2LPfhckm8=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no oI4QcipZ7ISJrlGviuO8buduvEGBqizYB54yLPiaPD
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool minio-docker-c /srv/volumes/minio-docker-c 1M on yes jA3nuYBGhvagRYLBXRacXsk6MiQoB60Dwz9iptgYmU
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes MDW2Jl7Hm1ihD221jF6I203sJLfTaBrjy1RUdBUR5o
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes V1iQudcksTsbOWnSUdqrRkv3xBcruOOYKn6DSU1u2L
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes c8hVACbWfIR76MxAOyMKgKMHu7UCQK3aOYmYfYfiaF
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no P1r2cE6SvkH28aSWp87EmL7F91wxnrnpBwaCjBW5HX
provision_zfs_dataset rpool vault /var/lib/vault 4k on no 89c3aXE63HDhi0hfFnU3BrQUgU0YOKUR9tnzJ6TJEf
    ...
    systemd.services.node_exporter = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${pkgs.prometheus-node-exporter}/bin/node_exporter" +
          ...
          " --web.listen-address=10.17.1.10:9100" +
...
# NIX REGION l3_vpn_hop_interface START
  ...
  systemd.services.vpn-gre-tunnel = {
    ...
    script = ''
        ip tunnel add vpnGre mode gre local 10.17.1.10 key 17
        ip addr add 10.17.129.10/17 dev vpnGre
...
# NIX REGION epl_nft_rules_l3-vpn-hop-address-translation END
    ...
    networking.interfaces.eth0.ipv4.addresses = [
      { address = "10.17.1.10"; prefixLength = 24; }
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"c44394784b45e950eae29d85cc6d9a0659397c7b510f67cf33f354bd54b78fd5\",hostname=\"server-c\"} $BOOT_TIME
" > $METRICS_FILE.tmp
