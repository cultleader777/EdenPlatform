...
async fn consul_servers_available_from_region_us_west_to_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("consul.service.us-west.consul", &["10.17.0.10", "10.17.0.11", "10.17.1.10"]),
...
async fn consul_servers_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("consul.service.consul", &["10.17.0.10", "10.17.0.11", "10.17.1.10"]),
...
#[tokio::test]
async fn dcrouter_nodes_have_internet_region_us_west_dc_dc_1() -> Result<(), Box<dyn Error>> {
...
#[tokio::test]
async fn dcrouter_nodes_resolve_public_dns_region_us_west_dc_dc_1() -> Result<(), Box<dyn Error>> {
...
async fn dns_all_servers_resolve_from_master_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ...
        ("server-c.us-west.epl-infra.net", &["10.17.1.10"]),
        ("server-d.us-west.epl-infra.net", &["10.17.1.11"]),
        ("server-e.us-west.epl-infra.net", &["10.17.0.12"]),
        ("server-f.us-west.epl-infra.net", &["10.17.1.12"]),
...
async fn dns_ns_servers_resolve_from_all_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("ns1.us-west.epl-infra.net", &["10.17.1.11"]),
        ("ns2.us-west.epl-infra.net", &["10.17.1.10"]),
...
async fn dns_ptr_records_resolve_from_master_us_west() -> Result<(), Box<dyn Error>> {
    let ptr_and_dns: &[(&str, &[&str])] = &[
        ...
        ("10.1.17.10.in-addr.arpa.", &["ns2.us-west.epl-infra.net."]),
        ("11.1.17.10.in-addr.arpa.", &["ns1.us-west.epl-infra.net."]),
        ("12.0.17.10.in-addr.arpa.", &["server-e.us-west.epl-infra.net."]),
        ("12.1.17.10.in-addr.arpa.", &["server-f.us-west.epl-infra.net."]),
...
async fn dns_root_servers_resolve_from_master_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("ns1.epl-infra.net", &["10.17.1.11"]),
        ("ns2.epl-infra.net", &["10.17.1.10"]),
...
async fn docker_registry_us_west_dns_exists() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-docker-registry.service.consul", &["10.17.0.10", "10.17.0.11", "10.17.0.12", "10.17.1.10", "10.17.1.11", "10.17.1.12"]),
...
async fn internal_nodes_resolve_public_dns_region_us_west_dc_dc_1() -> Result<(), Box<dyn Error>> {
    let servers_and_domains: &[(&str, &[&str])] = &[
        ("10.17.0.12", &["example.com"]),
        ("10.17.1.12", &["example.com"]),
...
#[tokio::test]
async fn intra_dc_dc_1_inside_subnet_ping_10_17_1_0p24_works() -> Result<(), Box<dyn Error>> {
    let servers_and_ips: &[(&str, &[&str])] = &[
        ("10.17.1.12", &["10.17.1.10"]),
        ("77.77.77.12", &["10.17.1.12"]),
...
#[tokio::test]
async fn intra_dc_dc_1_subnet_ping_from_10_17_0_0p24_to_10_17_1_0p24_works() -> Result<(), Box<dyn Error>> {
    let servers_and_ips: &[(&str, &[&str])] = &[
        ("10.17.0.10", &["10.17.1.10", "10.17.1.12"]),
        ("10.17.0.12", &["10.17.1.10", "10.17.1.12"]),
...
#[tokio::test]
async fn intra_dc_dc_1_subnet_ping_from_10_17_1_0p24_to_10_17_0_0p24_works() -> Result<(), Box<dyn Error>> {
    let servers_and_ips: &[(&str, &[&str])] = &[
        ("10.17.1.12", &["10.17.0.10", "10.17.0.12"]),
...
async fn minio_cluster_global_instances_available_in_dns() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-minio-global.service.consul", &["10.17.0.10", "10.17.0.11", "10.17.1.10", "10.17.1.11"]),
...
async fn monitoring_cluster_default_dns_exists() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-mon-default-prometheus.service.consul", &["10.17.0.10", "10.17.1.10"]),
...
async fn nomad_clients_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("nomad-clients.service.consul", &["10.17.0.10", "10.17.0.11", "10.17.0.12", "10.17.1.10", "10.17.1.11", "10.17.1.12"]),
...
async fn nomad_servers_available_from_region_us_west_to_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("nomad-servers.service.us-west.consul", &["10.17.0.10", "10.17.1.10", "10.17.1.11"]),
...
async fn nomad_servers_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("nomad-servers.service.consul", &["10.17.0.10", "10.17.1.10", "10.17.1.11"]),
...
async fn pg_deployment_testdb_dns_exists() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-pg-testdb.service.consul", &["10.17.0.10", "10.17.0.11"]),
...
async fn vault_servers_available_from_region_us_west_to_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("vault.service.us-west.consul", &["10.17.0.11", "10.17.1.10", "10.17.1.11"]),
...
async fn vault_servers_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("vault.service.consul", &["10.17.0.11", "10.17.1.10", "10.17.1.11"]),
