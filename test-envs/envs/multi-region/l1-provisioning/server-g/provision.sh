...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  "acl": {
    ...
    "tokens": {
      ...
      "initial_management": "2685eb55-bfc2-4f81-a56b-1effc872993d"
    }
  },
  "addresses": {
    "dns": "127.0.0.1",
  ...
  "advertise_addr": "10.18.0.12",
  "advertise_addr_wan": "10.18.0.12",
  "auto_encrypt": {
    "allow_tls": true
  },
  "bind_addr": "10.18.0.12",
  "bootstrap": false,
  "bootstrap_expect": 3,
...
bind_addr = "10.18.0.12"
advertise {
    http = "10.18.0.12:4646"
    rpc = "10.18.0.12:4647"
    serf = "10.18.0.12:4648"
}
...
client {
  ...
  meta = {
    "private_ip" = "10.18.0.12"
    "run_unassigned_workloads" = "1"
    "lock_epl-ingress-us-east" = "1"
    "lock_epl-minio-server-g-main-us-east" = "1"
    "lock_epl-mon-server-g-am-main-us-east" = "1"
    "lock_epl-mon-server-g-main-us-east" = "1"
  }
...
cluster_addr = "https://server-g.us-east.epl-infra.net:8201"
api_addr = "https://server-g.us-east.epl-infra.net:8200"

plugin_directory = "/usr/local/lib/vault/plugins"

listener "tcp" {
  address = "10.18.0.12:8200"
  cluster_address = "10.18.0.12:8201"
...
storage "raft" {
  path = "/var/lib/vault"
  node_id = "server-g.us-east.epl-infra.net"
  ...
  retry_join {
    leader_api_addr = "https://server-h.us-east.epl-infra.net:8200"
    leader_ca_cert_file = "/run/keys/vault-ca.crt"
    leader_client_cert_file = "/run/keys/vault-instance.crt"
    leader_client_key_file = "/run/keys/vault-instance.key"
  }
...
host = "server-g.us-east.epl-infra.net"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
i0J9XlNWkM+FwSQRXIi+cv2P9hdevaL0Va8O9LrtTHY=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIPVr0/D84yvHLaZFErlGAE5yTB8QgWngbnI1RLfZwK0eoAoGCCqGSM49
AwEHoUQDQgAEGTwG+4XCkodp09G9JRHTVXiidcRRWnzXnzBy9XxttnfH4avXV+LU
2t0lUOxu3492KfO+AlZXWUGKLuOsh9WQOA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
2685eb55-bfc2-4f81-a56b-1effc872993d
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
729640ca-6e78-40ae-af65-dc869339dbf4
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
7a7f5350-c54d-485c-96a9-9d9c3e126b10
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
bf67b77a-d352-4861-8ef2-4e7236255289
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
79b92c0b-0c73-44cf-b972-2b2660284ef7
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
c3Vsgglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIgNlIsnB50wv2Z
aRXFucjJRKRCa6tozIyWzFDff6lATxkCIQCynpHaVNyrb77Kr5zrUrVdPrWSx73I
KvnvMkGFJXnoxA==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEINOjOj6+A6hMxB2Dk7bybH9/DcIpyhIZYhbohXBYPYHwoAoGCCqGSM49
AwEHoUQDQgAEKYvhkHyx7jCAmMBDZD4Iy0H/bCqpfBLMYU0o7C1RYsmwyih45yfG
oRSYPCZSRcO+IWhEXKDdaOWF3KEsONhtCw==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
76a82c06-cff8-4f17-8421-bb8a009743d0
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIgVKrlw+DckxCQ4c6D
UhdXFvG+ompUd5+7obF8iidebYACIQDakqkp1V9aC4XPYiUUsiHyIQFJIV+OUjWc
/G9Pthif2g==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIGQf7D0gZKTglWM5wob0Z+MeC8wcvUQdijLHfIBFsnESoAoGCCqGSM49
AwEHoUQDQgAExx+LEH92JeWctCvanOiG6Ew8z+Um+BEoFI6m2dHzb1BULPo+Zl58
NqKKFGNOjJT1YIg3LSxkO0vC0tBw7hPnCA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
CMEqAJH0O4aKv5Ju326JLHClq8e7jsoB9u05b9jmIGw=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no duDPCqLwPx28wsqo6JhABfBeHHjdRtWyfQle9967LK
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes pSERxbMrFklKWVhyvx7bhMkK0faC6YdBJ6RI8gQJNr
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes htYd7E9BSsIP5vUwIzxQWWbtozhhdft14k1eRM3B9Z
provision_zfs_dataset rpool mon-secondary /srv/volumes/mon-secondary 4k on yes 4uTswJjRWWRnQRBcmEoE3tn6NFXy3OqHyq23C1lKOF
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes 5IUpOT5BXs8DtqtwTYusZOaNDLMqREhXcNSyMhRyDe
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no 9Kdcr8vsv6oKcHPDfdc1gk6i1kWyAaXJb81KwWKe11
provision_zfs_dataset rpool vault /var/lib/vault 4k on no 8ZQ6X3Kk3XlA8Lh2rDkTXkLYvvRIi3D3x3RmJxnvbX
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-g.dc2.us-east.multi-region:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-g.dc2.us-east.multi-region: \w\a\]\u@server-g.dc2.us-east.multi-region:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-g.dc2.us-east.multi-region:\u:\w\007\]$PS1"
       fi
     fi
   '';
    ...
    systemd.services.node_exporter = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${pkgs.prometheus-node-exporter}/bin/node_exporter" +
          ...
          " --web.listen-address=10.18.0.12:9100" +
...
wg set wg0 peer "XEKjOzgV/u0fY2Rd8ULFuwrqa5YgTENFvE0bXt/J62Q=" allowed-ips "172.21.7.10/32,10.17.0.0/16" endpoint "77.77.77.10:51820"
...
# NIX REGION frr_bgp_config START
  ...
  services.frr.bgp = {
      ...
      config = ''
        !
        router bgp 64530
          bgp router-id 10.18.0.12
          address-family ipv4 unicast
            network 10.18.0.0/16
          exit-address-family
          neighbor 10.18.0.13 remote-as 64530
          neighbor 10.18.0.13 password RlCOZakQrxqa0GuVTs3kzFWzxYk5Pfpn8GwxaSbUTX
          neighbor 10.18.0.13 bfd
          neighbor 172.21.7.10 remote-as 64529
          neighbor 172.21.7.10 password Fv9cqJQ9Ga8eu80wDsFmGvCONIlQu4WzPHr7wicUU0
...
# NIX REGION keepalived END
    ...
    networking.interfaces.eth0.ipv4.addresses = [
      { address = "10.18.0.12"; prefixLength = 24; }
...
if [[ ! $( timeout 0.5s dig @127.0.0.1 server-g.us-east.epl-infra.net +dnssec +short ) ]]
then
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"82942de3578258984808c0df41d3529f355037e391444c01761002c7320a668b\",hostname=\"server-g\"} $BOOT_TIME
" > $METRICS_FILE.tmp
