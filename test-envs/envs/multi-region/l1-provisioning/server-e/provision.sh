...
client {
  ...
  meta = {
    ...
    "lock_epl-minio-server-e-main-us-east" = "1"
    "lock_epl-mon-server-e-am-main-us-east" = "1"
  }
...
host = "server-e.us-east.epl-infra.net"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
eyWFrm6fH1jxSRzi6BYlRP1LTN1uEhK0acSZVkwpWis=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----
MIICxTCCAmqgAwIBAgIQcZD3PzMBPBMi3kA6kG0FSjAKBggqhkjOPQQDAjCBuTEL
...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIHEZ2RxFe1vf0OdOfsmZ4UtI+Qq0+8Dl00vyuDSFRPJ8oAoGCCqGSM49
AwEHoUQDQgAEBHyQyrAUNrglNr6mmJDfl4zeDMC/6k3TCH43qacrhorTvPV3uwiv
ke/eA3R2ynSNfuVcvrHcflWv5MsqvtWQOA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no Es2FhRshIQBuC36s5Tuqaki7gi1TwngGjQmkiU8eFK
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes 8qPe40ep8Q94aRPQMm0TKJFZUVXSSJngcHOiS2sul1
provision_zfs_dataset rpool mon-secondary /srv/volumes/mon-secondary 4k on yes 50mZp2HuzqZi7NYOZEgbMcfylqVRCvAiUnEKowWwyC
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no sb5KXOBEbjHIlLSSSPaOQEH4FnF031iGtpOIINSP5j
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes lWQXqCv6BaX00OEqBSdswruDfWzd3ZXiY994VYotO8
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-e.dc2.us-east.multi-region:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-e.dc2.us-east.multi-region: \w\a\]\u@server-e.dc2.us-east.multi-region:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-e.dc2.us-east.multi-region:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
if [[ ! $( timeout 0.5s dig @127.0.0.1 server-e.us-east.epl-infra.net +dnssec +short ) ]]
then
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"a704a7562f279ae1c05e91951b125b2d8dc9723afff6d9dfd94955f0f99f1839\",hostname=\"server-e\"} $BOOT_TIME
" > $METRICS_FILE.tmp
  ...
  echo '
epl_l1_provisioning_expected_hash{hash="a704a7562f279ae1c05e91951b125b2d8dc9723afff6d9dfd94955f0f99f1839",hostname="server-e"} 1
epl_l1_provisioning_expected_hash{hash="3e262cdb9fe5b92dedc9c66be079313137671c87ba9b624697f8d1470c22f710",hostname="server-f"} 1
epl_l1_provisioning_expected_hash{hash="82942de3578258984808c0df41d3529f355037e391444c01761002c7320a668b",hostname="server-g"} 1
epl_l1_provisioning_expected_hash{hash="ad84f74067a5d9c8985f28fca1f526ef3903df04b12ee716c92e4810afc16a9f",hostname="server-h"} 1
