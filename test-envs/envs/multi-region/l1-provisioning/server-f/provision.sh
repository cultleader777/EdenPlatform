...
consul {
    ...
    cert_file = ""
    key_file = ""
    token = "79b92c0b-0c73-44cf-b972-2b2660284ef7"
...
client {
  ...
  meta = {
    ...
    "lock_epl-minio-server-f-main-us-east" = "1"
  }
...
cluster_addr = "https://server-f.us-east.epl-infra.net:8201"
api_addr = "https://server-f.us-east.epl-infra.net:8200"
...
storage "raft" {
  path = "/var/lib/vault"
  node_id = "server-f.us-east.epl-infra.net"
...
host = "server-f.us-east.epl-infra.net"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
tIw6U/vT793S1e/d5XLVzcVuKYdfruG8F2hqCEpHqlA=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----
MIICxDCCAmqgAwIBAgIQYBy3dR7TTlB7EbGkyKoznjAKBggqhkjOPQQDAjCBuTEL
...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIAs8T3HmGMTpQ2d/2YsJByOz2asQ39dz63NoTSN6iU/JoAoGCCqGSM49
AwEHoUQDQgAEs2n8T9YALdUlfkkbpJ9ipdbfn65ygJZ3hNytEamIDOh2d5LArF1l
aKBruPFSVXOxH4LabAY+ur8xycKvT6JDXQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIM9tAXtzTSVjYCNOoJNmYN58Co6na47mH603H70hNlv5oAoGCCqGSM49
AwEHoUQDQgAEnKfmZ4lf13YeukoXHdne7TQ+tsBUjL48oVh+Jh5t1AqbBENnF4WZ
bfSpvt2B94W2VfZitKt89UEf+BRMDq5Mqg==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIhAMUgdt/XZTE8WluE
rnZGDTV0Ew6CU3dbRgdh0oZ7OzO+AiBV1GV3TB3jRzv3dgrOPi4ngC4zaVk1QOoi
7tXW8Hcwfg==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEICsUjKdvjaYWLtQr4lzGB9UoTDfObwCEoPs2Q72QMy6DoAoGCCqGSM49
AwEHoUQDQgAEFMgt0HO5324gCDMTFMI0dySbWakIJ2fam0az4wpgGZyjf7XARis/
aR085OsZiv0jq60zREvAH3jtUQi9+49CNQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no RRwrsBt5XrsnbsOQ6T8WxrjYKPlUWIf4M4jCFYf6iN
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes vOexuVAQDx84r4PCV30i4t4vSx4mFYgYiDOq122bE0
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes 5YVgM4oJmSk82bxaDImU7U6h8PWZdnQ1zpxdd9Ru3R
provision_zfs_dataset rpool vault /var/lib/vault 4k on no yBUQv3GocBxDunIYvl959Wrcint3ypd9zvThoMfRBs
...
# NIX REGION static_node_routes START
    ...
    networking.interfaces."eth0".ipv4.routes = [
      ...
      { address = "10.0.0.0"; prefixLength = 8; via = "10.18.0.2"; }

      { address = "0.0.0.0"; prefixLength = 0; via = "10.18.0.2"; }
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-f.dc2.us-east.multi-region:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-f.dc2.us-east.multi-region: \w\a\]\u@server-f.dc2.us-east.multi-region:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-f.dc2.us-east.multi-region:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
if [[ ! $( timeout 0.5s dig @127.0.0.1 server-f.us-east.epl-infra.net +dnssec +short ) ]]
then
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"ac39c33077dcd1fc97a61bae693557cf4b095a7b30f1d921438686b065f36627\",hostname=\"server-f\"} $BOOT_TIME
" > $METRICS_FILE.tmp
