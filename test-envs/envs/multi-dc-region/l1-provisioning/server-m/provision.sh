...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  ...
  "advertise_addr": "10.19.1.12",
  "advertise_addr_wan": "10.19.1.12",
  "auto_encrypt": {
    "tls": true
  },
  "bind_addr": "10.19.1.12",
...
bind_addr = "10.19.1.12"
advertise {
    http = "10.19.1.12:4646"
    rpc = "10.19.1.12:4647"
    serf = "10.19.1.12:4648"
}
...
client {
  ...
  meta = {
    "private_ip" = "10.19.1.12"
    "run_unassigned_workloads" = "1"
    "lock_epl-nats-server-m-main-nats" = "1"
  }
...
host = "server-m.us-west.epl-infra.net"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
/MaSXZd148x//VrRRhbd5cMsHtHzCSEQ5Dt7NJ4IsAU=
LilBoiPeepLikesBenzTruck
...
provision_zfs_dataset tank nats1 /srv/volumes/nats1 4k on yes icEWuQphyTAA0ib1zsEWRLllLkOagLWtc7aAdgRPor
...
if [[ ! $( timeout 0.5s dig @127.0.0.1 server-m.us-west.epl-infra.net +dnssec +short ) ]]
then
