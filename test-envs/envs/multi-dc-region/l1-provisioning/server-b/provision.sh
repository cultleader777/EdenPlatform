...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
rVXlWn2FRP0SaLj0crdhNLVTeSpXc+3edOpNixhA5tw=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
AwIDSQAwRgIhAIGkXBVfTA+LpeNxrGsEzdefAFHUFD+I0PqzoOA/QjmsAiEAp7GM
DKAMEIyiO/nA1XHjkJViyetek4RRxU1QxwzLdzY=
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIEhUUvurkXO2sa8TTeStcDC4EO5S/uyjupdAY/Tst682oAoGCCqGSM49
AwEHoUQDQgAELTtvfz5MPNpijbWIcLJQierfmUo8o+UGmrw8n7WE4UxRAqUhXyE6
HdtwBwiHvHS5QeE7FgvHD+0bQ7qYVhMy9g==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSQAwRgIhAP9Jwnr2suAevqax
LmeP1RiuvPbfv5r3Ezt3ZJEtZQPGAiEAhdkk+zefZbtRwsYsItAWb981W0/grJgN
ToxgsODc1BY=
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIMkF/OiAYKsMpjMI4kCziQFrIGHx5DeIh/O08rdDvTT6oAoGCCqGSM49
AwEHoUQDQgAE1pYj2HPKTvW4i8317ZNEGekyx/7qMyV7BEnZAg3iEVS1HixtqeVz
IpDIQXSUZTA24ayvYZfK02gyQGkmeysrVQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
qKPgrdw11ytJa/9W9XigFlzI5ZHmVFxqFpj2W1fnFmE=
LilBoiPeepLikesBenzTruck
...
provision_zfs_dataset rpool minio-docker-b /srv/volumes/minio-docker-b 1M on yes jOoWza37XlZ0SjKn1LR5nOQymfz033PF9DtqZCSUvE
provision_zfs_dataset rpool vault /var/lib/vault 4k on no tkT4gFQfVretkwUfMARsvRyVFEOvm16KYLxbUKlAeE
...
# NIX REGION epl_nft_rules_epl-internet-fw START
       ...
       chain EPL_INTERNET_FIREWALL {
           ...
           iifname enp2s0 ip saddr != { 10.0.0.0/8, 172.21.0.0/16 } ip daddr != { 77.77.77.11/32 } drop comment "Disallow traffic from internet to internal networks";
       }
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-b.dc1.us-west.multi-dc-region:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-b.dc1.us-west.multi-dc-region: \w\a\]\u@server-b.dc1.us-west.multi-dc-region:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-b.dc1.us-west.multi-dc-region:\u:\w\007\]$PS1"
       fi
     fi
   '';
  ...
  services.frr.bgp = {
      ...
      config = ''
        ...
        router bgp 64529
          ...
          neighbor 10.17.0.10 password K1R0yi1RUSobddXmU7pCUamxY4JVA6CaV4BRXm0Loj
          neighbor 10.17.0.10 bfd
          neighbor 172.21.7.13 remote-as 64530
          neighbor 172.21.7.13 password kqYiRlQkDWfe3eQFrzJzl5wPRBKo2HKOG40EZHdJX5
          neighbor 172.21.7.13 bfd
          neighbor 172.21.7.15 remote-as 64531
          neighbor 172.21.7.15 password 5tsWLbuERm4LT2DWgIZZ3YJx9LJzPpwts8pnqtx5um
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"5ece141f247325d73f6c8598ce69bcbc67df15d2b457cd599330f02c21d991d6\",hostname=\"server-b\"} $BOOT_TIME
" > $METRICS_FILE.tmp
