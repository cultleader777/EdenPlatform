...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  ...
  "advertise_addr": "10.19.1.11",
  "advertise_addr_wan": "10.19.1.11",
  "auto_encrypt": {
    "tls": true
  },
  "bind_addr": "10.19.1.11",
...
bind_addr = "10.19.1.11"
advertise {
    http = "10.19.1.11:4646"
    rpc = "10.19.1.11:4647"
    serf = "10.19.1.11:4648"
}
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
XN/W6K7nmqXEaMhmvW8FmokQAnkYRtuMU67bCaQVGss=
LilBoiPeepLikesBenzTruck
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-i.dc3.us-west.multi-dc-region:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-i.dc3.us-west.multi-dc-region: \w\a\]\u@server-i.dc3.us-west.multi-dc-region:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-i.dc3.us-west.multi-dc-region:\u:\w\007\]$PS1"
       fi
     fi
   '';
    ...
    systemd.services.node_exporter = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${pkgs.prometheus-node-exporter}/bin/node_exporter" +
          ...
          " --web.listen-address=10.19.1.11:9100" +
...
# NIX REGION keepalived END
    ...
    networking.interfaces.enp1s0.ipv4.addresses = [
      { address = "10.19.1.11"; prefixLength = 24; }

    ];

    networking.interfaces.enp2s0.ipv4.addresses = [
      { address = "10.19.252.13"; prefixLength = 22; }
