...
/run/current-system/sw/bin/ip route add 10.17.0.1/32 via 10.19.0.1
...
cluster_addr = "https://server-e.us-west.epl-infra.net:8201"
api_addr = "https://server-e.us-west.epl-infra.net:8200"

plugin_directory = "/usr/local/lib/vault/plugins"

listener "tcp" {
  address = "10.19.0.10:8200"
  cluster_address = "10.19.0.10:8201"
...
storage "raft" {
  path = "/var/lib/vault"
  node_id = "server-e.us-west.epl-infra.net"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
FPox9Ml45qaXMJS8NwYJPWiOsvLXusGBVIYGkG09uYk=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIIu9K0x6Rtsm9JkMmejC9Wf/QGucMdcyTLoH4EdNXcfeoAoGCCqGSM49
AwEHoUQDQgAELN+KHAw1SeLpnrjXQV7DE+1doTnPJPjC6Np9VHaKH1gBvKXZPn7E
RHjH5bEQxGpv9Os7GmdXze2hesj/ES2UZw==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIgQ7pUljCSZ7PkM50T
E36heSd3faybRR8Wg8xuc17CebECIQCs5qgXKREFqupcKfaMxhtOpPUYVzB0uAwJ
xl5ZX+eFmw==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIJ383OJEPd/iKQq+vcBdSl2hvx5oCubbrbWMo4pwuE0AoAoGCCqGSM49
AwEHoUQDQgAEa3kXvPfNdlaoAPHp6sir3GNxoSRuYk1rOedJC8AikIKtZyzZvFdR
tnWbRvBgfodr4A1tmhGpB5HZxjqQStSdWA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
YDE4nnt2P9chPQTD8kQi4yfImm54f7w0SSKEzjZr4n8=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool am-default /srv/volumes/am-default 4k on yes eU99udw9IlDyPE7OsUNvtBN0X43H9J1qJhNFn65c85
provision_zfs_dataset rpool consul /var/lib/consul 4k on no dhb9HdH6xbV7hIsof2fZ7DQz0AgNnWbs7Cwkpltipb
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool minio-docker-c /srv/volumes/minio-docker-c 1M on yes wLUelrsQ4AdlnqSUik8jsK551Qs5kk6R5zoiOnWctJ
provision_zfs_dataset rpool minio-docker-e /srv/volumes/minio-docker-e 1M on yes 4DKwae0qvFPVKa1crgU0UPaZ5AgCCDyzfSfIzCwjNj
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes fMG3SrirvovMBhsmzBFm2RjQoHAur16J1WVeLWuND7
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no Pdt5Hc8JGAgz2ageSSNe0xNXbA3fStKabI2T23GW2h
provision_zfs_dataset rpool vault /var/lib/vault 4k on no 5bHUAhIn9YFD7xVBw2pbYM9xuBp5CVH7S7pCbNHTkP
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"11a1b380297d38c1043fb992697aa3b584cecf725c30aba807356c61016093cf\",hostname=\"server-e\"} $BOOT_TIME
" > $METRICS_FILE.tmp
