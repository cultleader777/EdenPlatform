...
storage:
  trace:
    ...
    s3:
      ...
      access_key: tempo_us_west
      secret_key: {{ with secret "epl/data/tempo/us-west" }}{{ .Data.data.minio_bucket_password }}{{ end }}
      insecure: true

querier:
  frontend_worker:
    frontend_address: epl-tempo-us-west.service.consul:4311
