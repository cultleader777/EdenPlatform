...
check_zfs_root virtio-server-a-vda
check_server_disabled_swap
check_server_architecture x86_64
check_core_count 8
check_at_least_memory_bytes 7730941132
check_iface_has_ip eth0 10.17.0.10/24 server-a lan
check_expected_disk /dev/disk/by-id/virtio-server-a-vda 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdb 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdc 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdd 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vde 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdf 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdg 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdh 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdi 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-a-vdj 21474836480 ssd
check_xfs_disk /dev/disk/by-id/virtio-server-a-vdb
