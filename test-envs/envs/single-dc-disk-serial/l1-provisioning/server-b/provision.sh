...
consul {
    ...
    cert_file = ""
    key_file = ""
    token = "24135b35-2b37-4238-835f-6ccc61c0b0b0"
...
client {
  ...
  host_volume "minio-docker" {
    path = "/srv/xfs-jbods/virtio-server-b-vdb/minio-docker"
    read_only = false
  }
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
KPZFxPY7jOQd77P5u7OX75//EzjTh+Fdb+EdD9YDEag=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIKDAoaho5OTmPE0Kuex+27yXsMYYLKtti5ffELAE/CCCoAoGCCqGSM49
AwEHoUQDQgAE5te8YUg41ZPUglmClK4lPnz4MHHP6bCHpcLF/Fm6H4jNBmKYgBW4
KJXyprwkOPJqs7fOG7ie9zJpzduKQ8R6vw==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIEXx7CZ8B03K4Rr1OjmJZLMZpjIXbPq+YaZ/oMhF7uyQoAoGCCqGSM49
AwEHoUQDQgAEqD2q7NGOrDq/0R5Wypw/5iO6JCEZswBBESbHfq6Zz1H9WnmwVEiF
yk3mRMviyb9fKmgjMMJE1YngjOx3xMdT4A==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIhAOe9Z4DqQUG3cPe8
rKX0fjtStWfWeEBLGQUHTGNz/ldcAiAH4v4LCd4O+6Yc21IttUh/lihwssOJFyLF
drkBd6Dx4g==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIHkAhfo1Fw6kw8skamWGuR0p9kK1yBJYyQxbHRYFDiCEoAoGCCqGSM49
AwEHoUQDQgAE/g+m68tFxHQjuFZTD8faxM7l72jdTA9Z2ixHOwcAd7/XN9nh6fFe
Oqzd2BdXhFX1nPRqvpFgjQkJeFZOEzMWSA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool ch-keeper /srv/volumes/ch-keeper 4k on yes eDR02FfEbRek5olYosZmd7q2QJpXbEcaC98I8behAy
provision_zfs_dataset rpool clickhouse /srv/volumes/clickhouse 4k on yes x7AqjqW0Jqmd9oq7Hu792yaXY9Z0V575UuaUdagLHi
provision_zfs_dataset rpool consul /var/lib/consul 4k on no m9JRgIHtqqaHaxRvOQW8Fg8mkU7Uplnq4CKxwc6ALT
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes 6XniOzQEykDQOGCFEpbMmGsRCdQ8yzWzvXjdio2yCZ
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes bySLwwJsNa9TlcQTvgVQY4mbS7izxoFwfAsthGoGAQ
provision_zfs_dataset rpool vault /var/lib/vault 4k on no HQNHtPmAuTj5X377JF6x3KTh4IM3xoSCduz95D36Io


mkdir -p /srv/xfs-jbods/virtio-server-b-vdb
chmod 700 /srv/xfs-jbods/virtio-server-b-vdb

# we don't bother with nixos config or fstab
# because we must run l1 provisioning post boot anyway
CURR_FS_TYPE=$( lsblk -n -o FSTYPE /dev/disk/by-id/virtio-server-b-vdb )
if [ -z "$CURR_FS_TYPE" ]
then
    # if disk is empty provision xfs filesystem
    nix-shell -p xfsprogs --command 'mkfs.xfs /dev/disk/by-id/virtio-server-b-vdb'
fi

if ! mount | grep '/dev/disk/by-id/virtio-server-b-vdb'
then
    mount -o noatime /dev/disk/by-id/virtio-server-b-vdb /srv/xfs-jbods/virtio-server-b-vdb
fi

CURR_FS_SIZE=$( df --output=size -B1 /dev/disk/by-id/virtio-server-b-vdb | tail -n-1 )
CURR_DEVICE_SIZE=$( lsblk -n -o SIZE -b /dev/disk/by-id/virtio-server-b-vdb )
AT_LEAST_SIZE=$(( CURR_FS_SIZE + 536870912 ))
if [ "$AT_LEAST_SIZE" -le "$CURR_DEVICE_SIZE" ]
then
    echo "Block device /dev/disk/by-id/virtio-server-b-vdb expanded, expanding xfs filesystem..."
    nix-shell -p xfsprogs --command 'xfs_growfs /dev/disk/by-id/virtio-server-b-vdb'
fi

mkdir -p /srv/xfs-jbods/virtio-server-b-vdb/minio-docker
chmod 777 /srv/xfs-jbods/virtio-server-b-vdb/minio-docker
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-b.dc1.us-west.single-dc-disk-serial:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-b.dc1.us-west.single-dc-disk-serial: \w\a\]\u@server-b.dc1.us-west.single-dc-disk-serial:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-b.dc1.us-west.single-dc-disk-serial:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"50e367b99453a2a73e58a36d21886758d819044dd894732d9ad02db0a16b8d29\",hostname=\"server-b\"} $BOOT_TIME
" > $METRICS_FILE.tmp
