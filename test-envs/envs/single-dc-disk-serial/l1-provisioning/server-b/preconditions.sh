...
check_zfs_root virtio-server-b-vda
check_server_disabled_swap
check_server_architecture x86_64
check_core_count 2
check_at_least_memory_bytes 7730941132
check_iface_has_ip eth0 10.17.0.11/24 server-b lan
check_expected_disk /dev/disk/by-id/virtio-server-b-vda 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-b-vdb 21474836480 ssd
check_xfs_disk /dev/disk/by-id/virtio-server-b-vdb
