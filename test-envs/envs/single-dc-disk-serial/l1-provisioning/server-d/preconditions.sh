...
check_zfs_root virtio-server-d-vda
check_server_disabled_swap
check_server_architecture x86_64
check_core_count 2
check_at_least_memory_bytes 7730941132
check_iface_has_ip eth0 10.17.0.13/24 server-d lan
check_iface_has_ip eth1 77.77.77.13/24 server-d internet
check_expected_disk /dev/disk/by-id/virtio-server-d-vda 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-d-vdb 21474836480 ssd
check_xfs_disk /dev/disk/by-id/virtio-server-d-vdb
