...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  "acl": {
    ...
    "tokens": {
      ...
      "initial_management": "93902903-0f1f-423a-a803-192eaa6f235e"
    }
  },
  "addresses": {
    "dns": "127.0.0.1",
...
client {
  ...
  host_volume "minio-docker" {
    path = "/srv/xfs-jbods/virtio-server-c-vdb/minio-docker"
    read_only = false
  }
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
ZurO3Tmrd2S6eaMMDunMUp8Ll8gPJ4ThokQ8Wi+/Fjs=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIC8hBzdy5svL5JhFlX2FV8zNA/0prl/QzLiCqmz2DiP4oAoGCCqGSM49
AwEHoUQDQgAEjAMvc7Gq/5TEuQwLcSYGoBbOxbzFspx0YgRimvRRsRgGg/8HfnnH
X/4M0OxC0p0dYTsnKc23jOZxtfN1zGjs+Q==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
93902903-0f1f-423a-a803-192eaa6f235e
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
4ac7c3bb-2ca8-4df0-bb76-ec9fb4f6cc28
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
a08c13ba-e4fd-4a98-b958-b69006d22552
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
35efe809-72b5-4508-acfe-582d00b62a55
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
63c6dfc6-8e3e-4def-ae2e-71b45feca764
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
24135b35-2b37-4238-835f-6ccc61c0b0b0
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
2492c978-5889-4f06-9273-49c1b82a9807
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIgQiOArQhY59g7w9TY
MjhksJIsadtWHdBEniE6ucrEbE0CIQDSlqe4kmfkKCs4mYmj2qrMAUN1bLRjWVa7
nzsIlhHpCw==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIKCiA8wXOcnYDkCoUw0IvLlaawGleJu/M+d1ngSS5sxEoAoGCCqGSM49
AwEHoUQDQgAEB6Emc1HWWAVk2s4hAjb56XM2dIoMTTd9U8RlBDzY3ruOPw3fXC5K
H0QbpZid1eMtoGc4/xrIqEd/v/Dkre3WUw==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
OCgcci87sQyKwZ8gz7yHhwCYsXvrd4+o7HLfHWgOykY=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool clickhouse /srv/volumes/clickhouse 4k on yes 02WIhJ5ZZtMOn6CtLyPkp2GGuBKOEQf1ZGMyZA1og8
provision_zfs_dataset rpool consul /var/lib/consul 4k on no q3sRGUapdryKgJNk24i8cXHdcbkaZn4ZlE8X5JeO3q
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes PnpW4CtR46gbDrFwQRKOYHpNZOA1789mPJeFAK32Jh
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes Q0xWurjIjWvVON2PNkgKqkW3jOG5A1tFUpnXHKNI5J
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes tN5zMGVNlFlGYr0yvK7VRxlKf8ltWtGiSWgfk3y8oZ
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no 3oYkfVQr4TccH1IrNGRLpf3lhLqmcAGiWLAq61M6xp
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes THlmMWHBYtwPNKb3yunw3xQ20WHJrc2Cswwd3YDVxC
provision_zfs_dataset rpool vault /var/lib/vault 4k on no gD6hr4glp32SGoGhQiZgbTRFBIncbRDSwdyeUPEx4v


mkdir -p /srv/xfs-jbods/virtio-server-c-vdb
chmod 700 /srv/xfs-jbods/virtio-server-c-vdb

# we don't bother with nixos config or fstab
# because we must run l1 provisioning post boot anyway
CURR_FS_TYPE=$( lsblk -n -o FSTYPE /dev/disk/by-id/virtio-server-c-vdb )
if [ -z "$CURR_FS_TYPE" ]
then
    # if disk is empty provision xfs filesystem
    nix-shell -p xfsprogs --command 'mkfs.xfs /dev/disk/by-id/virtio-server-c-vdb'
fi

if ! mount | grep '/dev/disk/by-id/virtio-server-c-vdb'
then
    mount -o noatime /dev/disk/by-id/virtio-server-c-vdb /srv/xfs-jbods/virtio-server-c-vdb
fi

CURR_FS_SIZE=$( df --output=size -B1 /dev/disk/by-id/virtio-server-c-vdb | tail -n-1 )
CURR_DEVICE_SIZE=$( lsblk -n -o SIZE -b /dev/disk/by-id/virtio-server-c-vdb )
AT_LEAST_SIZE=$(( CURR_FS_SIZE + 536870912 ))
if [ "$AT_LEAST_SIZE" -le "$CURR_DEVICE_SIZE" ]
then
    echo "Block device /dev/disk/by-id/virtio-server-c-vdb expanded, expanding xfs filesystem..."
    nix-shell -p xfsprogs --command 'xfs_growfs /dev/disk/by-id/virtio-server-c-vdb'
fi

mkdir -p /srv/xfs-jbods/virtio-server-c-vdb/minio-docker
chmod 777 /srv/xfs-jbods/virtio-server-c-vdb/minio-docker
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-c.dc1.us-west.single-dc-disk-serial:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-c.dc1.us-west.single-dc-disk-serial: \w\a\]\u@server-c.dc1.us-west.single-dc-disk-serial:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-c.dc1.us-west.single-dc-disk-serial:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"8b41ca50232e3ecf24c40542b2e1b0fe7d422240a095d85cf7bc68c6125bf71b\",hostname=\"server-c\"} $BOOT_TIME
" > $METRICS_FILE.tmp
