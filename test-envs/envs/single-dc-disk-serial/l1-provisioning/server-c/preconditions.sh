...
check_zfs_root virtio-server-c-vda
check_server_disabled_swap
check_server_architecture x86_64
check_core_count 2
check_at_least_memory_bytes 7730941132
check_iface_has_ip eth0 10.17.0.12/24 server-c lan
check_iface_has_ip eth1 77.77.77.12/24 server-c internet
check_expected_disk /dev/disk/by-id/virtio-server-c-vda 21474836480 ssd
check_expected_disk /dev/disk/by-id/virtio-server-c-vdb 21474836480 ssd
check_xfs_disk /dev/disk/by-id/virtio-server-c-vdb
