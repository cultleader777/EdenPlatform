...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
QGx6tdy06w7hXNsLSSBNeLe5jH1i+P7/DETmmCSsJ0A=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no cDc4r68ctqbgfancR0qanY442IGMQABbDkqRIm6uvy
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool minio-docker-a /srv/volumes/minio-docker-a 1M on yes Odh3o8QClb2NSnZiTzcmoGxmi24eoAtOxFKNISyYUs
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes Z9Jeeu7zxN0vQyYv2zQevmz6BMbXlNnVhU5a3ky6cQ
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes A3j5i48iulc0N5ehgDmA8MLXBfoiEtz52deQovw7OE
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no RoUd6oK1wxWM8zfjW7ADl0nBP9jjijfd4sAiQjRC3y
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes 5m51gLceCSfdR5p53qqqXrZLMTd3yS3oZK7uJ5yqHl
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"0045aeb0546da7404f3d2f850877329f3c373b745b9878658c3f5c41587e273e\",hostname=\"server-a\"} $BOOT_TIME
" > $METRICS_FILE.tmp
  ...
  echo '
epl_l1_provisioning_expected_hash{hash="0045aeb0546da7404f3d2f850877329f3c373b745b9878658c3f5c41587e273e",hostname="server-a"} 1
epl_l1_provisioning_expected_hash{hash="e6e7e8081a4407410ae9fd4447aca3772ea8326869fd9e8a90e21859480e1cff",hostname="server-b"} 1
epl_l1_provisioning_expected_hash{hash="a9b02644743fd74dbe44deb15c321fb320f2b40fe69b1939180eee7e8a11b38e",hostname="server-c"} 1
epl_l1_provisioning_expected_hash{hash="3c2a2c10ac66fcb232e50df9677df54289b1b06d6dcd5af5060252ac88519903",hostname="server-d"} 1
