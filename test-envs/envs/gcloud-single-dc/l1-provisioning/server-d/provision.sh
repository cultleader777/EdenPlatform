...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
DlO8RuIqBH4vxq+ZIK4h+KU+N6aZBB9BZ2WxhNL1nMs=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIhAO7H8fDTIM6Ycf7N
ZZzcTa3eLLiRhRWB7D2FTboWkTWKAiBDF0F7J2FP2JAo8z2UTyhMTKGFfRww/XyG
LRd3rItCFQ==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIC0PZkVfrlPgcWTRmt6S0G87BddTMxeXPDx3UsfzMCBAoAoGCCqGSM49
AwEHoUQDQgAE5g4dio6+vLo+qEfasA0Ny8jcKcIs3VRpx591iAbiscL/OW2eltbz
UPKo0YbRfsqsSzkFeGzyk4VaoeSCJGkOtQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
CONS1ykPrROnLPlBpmE5xsK0V1ONm/huxpPY3bbAHUA=
LilBoiPeepLikesBenzTruck
...
# us-west.epl-infra.net.	IN	DS	13887 15 2 9733212423A9142931081FD281C37258726EA3A073BF1D89DE2C087274431B93
#
maybe_update_dns_file  /run/named/private-epl-infra.net.zone
# $TTL 3600
...
zpool import -af
provision_zfs_dataset rpool acme /var/lib/acme 128k on no 8n5Sqt6aui9erMDuPtBuAfRaCae43wIy3GaF4XsZcZ
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool minio-docker-d /srv/volumes/minio-docker-d 1M on yes kDvHEpiQuPiIXau9S8Vms17MyqwuTjuKIHbL9Kzaqr
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes xgdw1mqBDR6kegac9WK3ws6LJWDSFGonbVDWaLQvqR
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes 0s146QYLQ8fLYAn4OAdREHfkmQqf8I6oUdieRFnY9i
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no WFhFQ3QeOP4IgjezO99eIF59QaBuVDedkm0AV52bRP
provision_zfs_dataset rpool vault /var/lib/vault 4k on no ppp4OAP38pRvd2L02GS5pJVcaIV1vqcYO6TjhTrlbE


mkdir -p /srv/xfs-jbods/vda
chmod 700 /srv/xfs-jbods/vda

# we don't bother with nixos config or fstab
# because we must run l1 provisioning post boot anyway
CURR_FS_TYPE=$( lsblk -n -o FSTYPE /dev/disk/by-id/google-vda )
if [ -z "$CURR_FS_TYPE" ]
then
    # if disk is empty provision xfs filesystem
    nix-shell -p xfsprogs --command 'mkfs.xfs /dev/disk/by-id/google-vda'
fi

if ! mount | grep '/dev/disk/by-id/google-vda'
then
    mount -o noatime /dev/disk/by-id/google-vda /srv/xfs-jbods/vda
fi

CURR_FS_SIZE=$( df --output=size -B1 /dev/disk/by-id/google-vda | tail -n-1 )
CURR_DEVICE_SIZE=$( lsblk -n -o SIZE -b /dev/disk/by-id/google-vda )
AT_LEAST_SIZE=$(( CURR_FS_SIZE + 536870912 ))
if [ "$AT_LEAST_SIZE" -le "$CURR_DEVICE_SIZE" ]
then
    echo "Block device /dev/disk/by-id/google-vda expanded, expanding xfs filesystem..."
    nix-shell -p xfsprogs --command 'xfs_growfs /dev/disk/by-id/google-vda'
fi
...
# NIX REGION l3_vpn_hop_interface START
  ...
  systemd.services.vpn-gre-tunnel = {
    ...
    script = ''
        ip tunnel add vpnGre mode gre local 10.17.0.13 key 17
        ip addr add 10.17.128.13/17 dev vpnGre
...
cp -pu /run/keys/K10-in-addr-arpa--015-05433-private /run/dnsseckeys/K10.in-addr.arpa.+015+05433.private
cp -pu /run/keys/K10-in-addr-arpa--015-59598-private /run/dnsseckeys/K10.in-addr.arpa.+015+59598.private
cp -pu /run/keys/K10-in-addr-arpa--015-05433-key /run/dnsseckeys/K10.in-addr.arpa.+015+05433.key
cp -pu /run/keys/K10-in-addr-arpa--015-59598-key /run/dnsseckeys/K10.in-addr.arpa.+015+59598.key
cp -pu /run/keys/K17-10-in-addr-arpa--015-13355-private /run/dnsseckeys/K17.10.in-addr.arpa.+015+13355.private
cp -pu /run/keys/K17-10-in-addr-arpa--015-28699-private /run/dnsseckeys/K17.10.in-addr.arpa.+015+28699.private
cp -pu /run/keys/K17-10-in-addr-arpa--015-13355-key /run/dnsseckeys/K17.10.in-addr.arpa.+015+13355.key
cp -pu /run/keys/K17-10-in-addr-arpa--015-28699-key /run/dnsseckeys/K17.10.in-addr.arpa.+015+28699.key
cp -pu /run/keys/Kepl-infra-net--015-10687-private /run/dnsseckeys/Kepl-infra.net.+015+10687.private
cp -pu /run/keys/Kepl-infra-net--015-06259-private /run/dnsseckeys/Kepl-infra.net.+015+06259.private
cp -pu /run/keys/Kepl-infra-net--015-10687-key /run/dnsseckeys/Kepl-infra.net.+015+10687.key
cp -pu /run/keys/Kepl-infra-net--015-06259-key /run/dnsseckeys/Kepl-infra.net.+015+06259.key
cp -pu /run/keys/Kus-west-epl-infra-net--015-58245-private /run/dnsseckeys/Kus-west.epl-infra.net.+015+58245.private
cp -pu /run/keys/Kus-west-epl-infra-net--015-13887-private /run/dnsseckeys/Kus-west.epl-infra.net.+015+13887.private
cp -pu /run/keys/Kus-west-epl-infra-net--015-58245-key /run/dnsseckeys/Kus-west.epl-infra.net.+015+58245.key
cp -pu /run/keys/Kus-west-epl-infra-net--015-13887-key /run/dnsseckeys/Kus-west.epl-infra.net.+015+13887.key
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"3c2a2c10ac66fcb232e50df9677df54289b1b06d6dcd5af5060252ac88519903\",hostname=\"server-d\"} $BOOT_TIME
" > $METRICS_FILE.tmp
