...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  ...
  "advertise_addr": "10.18.0.10",
  "advertise_addr_wan": "10.18.0.10",
  "auto_encrypt": {
    "allow_tls": true
  },
  "bind_addr": "10.18.0.10",
  "bootstrap": false,
  "bootstrap_expect": 3,
...
bind_addr = "10.18.0.10"
advertise {
    http = "10.18.0.10:4646"
    rpc = "10.18.0.10:4647"
    serf = "10.18.0.10:4648"
}
...
listener "tcp" {
  address = "10.18.0.10:8200"
  cluster_address = "10.18.0.10:8201"
...
service_registration "consul" {
  ...
  service = "vault"
  service_tags = ""
  service_address = "10.18.0.10"
  token = "d99f4d98-9c0a-449f-8d3a-266cad5a4e49"
}
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
8vEivObQwiRVtScENtjSkRXThd8aRIiCA7rZjZzAZ7o=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----
MIICxDCCAmqgAwIBAgIQOc/ppQHNI+NroaN9eUARBDAKBggqhkjOPQQDAjCBuTEL
...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEID2S1pHvY8R+PZuJtlHs7ZLVR+jShWckm2fcFepmzL2+oAoGCCqGSM49
AwEHoUQDQgAEbW8WQP8i4zDQ3kRlIOH8uDuhCs7AJLBI7sUqrhVirbWtOyqIl7Wu
78rLLy73C58JTo7cPNP50Xa6GKiXuVTOxQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIhAOH7SE9abtJt2p7C
gClCU5kr1Z5SI00pHPhgCDmxJoEsAiAWtgbF3fkYGPeypp1FnA28varS+45/kuAH
J739Mv62Zg==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIKA4XWpdfgTLGfMcu0Q7n7QXSLQKgn2pS4DdJJarHcZDoAoGCCqGSM49
AwEHoUQDQgAE/QDvcMO9aErl9ONPoTZlydLOu0NOi5TknqZo1zkNXditxt75RBZ0
jIPB4tYsUj1afS+LGqWhcU7xeYKKjSS9nQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
EB+M3Y3BWdICX4ZoGxbse1XuIWZrnuG4awW+1S05z3c=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no uCZ305PbknpwzT6dQXiFB9kdRh91MZWVYw4mErcMpq
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool minio-docker-c /srv/volumes/minio-docker-c 1M on yes GTSBjWzP3iZzYMvTD2FK4S2wzQj9XXemZW4n2LfoJQ
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes ZbNvmZj68s8ccJo8nDRx1h2iHdFZLVEei6jvzEoiRX
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes mPqWFteYSiT2dMPXC8KeshZlBDPGWeVsZWZiTh7e4R
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes 3AJnIKWSunlEn6QGqsOU75QZtG3LMmmCAfbYLM2uLa
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes aYh4s13F1ceiE2nPG077kLKoTrynXjYQw8sCaZ7Z1C
provision_zfs_dataset rpool vault /var/lib/vault 4k on no ANYZj0N2UJo4QQdQjkMTgsz8DO4wcuAFozyXr801GC
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-c.dc2.us-west.aws-multi-dc:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-c.dc2.us-west.aws-multi-dc: \w\a\]\u@server-c.dc2.us-west.aws-multi-dc:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-c.dc2.us-west.aws-multi-dc:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
# NIX REGION keepalived END
    ...
    networking.interfaces.eth0.ipv4.addresses = [
      { address = "10.18.0.10"; prefixLength = 24; }
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"652d30ef2dc46c4cbe9c684d1291dc0b2c6c0ff439878113a7814afc501f5692\",hostname=\"server-c\"} $BOOT_TIME
" > $METRICS_FILE.tmp
