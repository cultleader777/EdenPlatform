...
nomad job run -detach nomad-jobs/epl_nats-main-nats.hcl
VAULT_TOKEN=$( cat /run/secdir/epl-job-tokens/epl-pg-testdb ) nomad job run -detach nomad-jobs/epl_pg-testdb.hcl
VAULT_TOKEN=$( cat /run/secdir/epl-job-tokens/epl-tempo-us-west ) nomad job run -detach nomad-jobs/epl_tempo-us-west.hcl
