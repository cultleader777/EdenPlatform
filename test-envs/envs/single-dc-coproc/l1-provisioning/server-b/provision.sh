...
consul {
    ...
    cert_file = ""
    key_file = ""
    token = "7bfb1eef-2c44-45b6-be97-be0bdee67afb"
...
client {
  ...
  meta = {
    ...
    "lock_epl-nats-server-b-main-nats" = "1"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
yuia5hYM7Lk+UcD2CqYOY2TJXDnaSRz0LcACFufKXFs=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----
MIICxTCCAmugAwIBAgIRAO9uKjPEXDvUu26amcbPiWswCgYIKoZIzj0EAwIwgbkx
...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEINLc7nuytXfTwg/dUmM9tSlbz1iLMQNBMO8mRjr3Lm19oAoGCCqGSM49
AwEHoUQDQgAEsHo8A3PVqouubmIwEmzx/T/DTtrbhBtjmKreH12dt4H+xhMKJZmM
pnCFu3Yc/j0ERqBz5yqXmOjivFuqN5XHOQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEILxIeOdeEf6N/t/sIw35aFV5H2ZNsDWjRY9diaG/7Z42oAoGCCqGSM49
AwEHoUQDQgAEEZZ+nZVtGxDqEUK6h5l5QU3EnTOnBT4St7BNGXQhYipxiFoUsmde
jexiZvGYhpLzmEX7BN7hqumJI+5d6MYJHg==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDRwAwRAIgFYq4LHbNF/kUvybs
a16A3Uoa8PW2gRyil7zsgt3mxgcCIFKBaMzzbFhdTBOM/DJ6NK3+8+7jVqUlWKaM
5o0GxKrk
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIJ33n3eEfcsuG8INDrpUtJ7FeIVWoVJl9B3035Wfl1yvoAoGCCqGSM49
AwEHoUQDQgAEONPEpVAGyIoCUk0Q18u02tq+gSYUQ0bcPmpbAOi2TKV0aZNdQ0fq
e5YJD7lYpDgd8GMpiJZNWSObTrsxlRNJmQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no H8hw5vJx1gYaWKlc4BLb3eIQw2iD3g6Rifyu4uJ75s
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes U3CeXIq91d2xUgIVYNiUMc2os1atNm4qtIOp0CVngu
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes XdXjquuDUZ01sQebFyW1ApgsmDB7ehnOELQ7Rt9kol
provision_zfs_dataset rpool vault /var/lib/vault 4k on no qJrj0pQbkVk5Z96LtQvWah3enW3GbzIkv46f64aGD3
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-b.dc1.us-west.single-dc:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-b.dc1.us-west.single-dc: \w\a\]\u@server-b.dc1.us-west.single-dc:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-b.dc1.us-west.single-dc:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"9b8914ba616cba953ae9141be58809373f46e4fcc9a5c6495eb1337c62e87305\",hostname=\"server-b\"} $BOOT_TIME
" > $METRICS_FILE.tmp
