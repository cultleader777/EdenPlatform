...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  "acl": {
    ...
    "tokens": {
      ...
      "initial_management": "541e7a57-56bc-45e0-84c6-6006fe52865a"
    }
  },
  "addresses": {
    "dns": "127.0.0.1",
...
client {
  ...
  meta = {
    ...
    "lock_epl-nats-server-c-main-nats" = "1"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
ejvS+KKqrV5kxlNfJoebk/SirSbazPCMG2XEowz/v34=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIFz5FGjJAF9/1DzRV5rtLkgLxZaGrc8k59VpjVtykLH1oAoGCCqGSM49
AwEHoUQDQgAELO7Ooo7xLb92EC1ayqWxJgic8DrtJctbgyYpfJXDwjtNfogU2ilo
VirRgeOO8GwNxbB+SKgNgWOxHXdSgDkstA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
541e7a57-56bc-45e0-84c6-6006fe52865a
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
475b6cd0-e040-4d93-a233-470f4a2566b9
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
9d2fd06f-0a78-4ae4-b97a-2ea884b281cf
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
7dcbfcc4-e9fe-43c9-9225-438ee09a1d7d
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
b3b25f71-9109-4b62-b57e-fbb93b695490
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
581ad3af-950b-49c3-b0be-48cc54c2bdfe
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
7bfb1eef-2c44-45b6-be97-be0bdee67afb
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
54a711d6-cbc6-4084-aa93-5431dde0fcdd
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIgTXu0WJhU3iZlkeV2
OUZgnHr2c6rZ0gA+4wv+y4W09SMCIQCxsHtKW6ASnTiY7JZu1/0edJISN5JXUU2C
XTbJeuhtng==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIIStmWTvAmbt0nF/FNEFCjH39mEmoNsYAY7FbeQtddqboAoGCCqGSM49
AwEHoUQDQgAE/mfHVTMkza/T9TBORyqBjiBug9TI9sUK+Vv8LWln+7zS5vDYkU7E
j2J8fmhpcij0ytfl3lRsJVvTxGqBuqdkrA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
iM8eqG8aULfxGAz+JknLVRY+AOhKNIhPTpeoEPuik3U=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no fFxdov1vaHHbeTIMzypGwoRCSgAO8aRniHtljVyx9H
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes p3ZvKrm7YiGrJEwtmYJrj3spTCApSu5lWxPhNjQ94T
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes LDymLCC6ZloPe724u1v5ZED6Gt7Gz2BuR7XFfX7KLT
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes G2N194XQNYl6cNgmFTizbACo1XGWhdOMrYD0Qk3vxz
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no 4FQbozJ2qAXrRadCCRZed7cgJ2kzX0VyXURVyEIRbN
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes 0yVupUoRI3wIfIQR2ln5gomqgvKPdJa5fpXr6U9azY
provision_zfs_dataset rpool vault /var/lib/vault 4k on no zaARqogTXY2mSNyrDg8VMw9TREkMiazj9UEJtBDiPU
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"21eb422b9e027ab2c88649239917e268f9c958cb7742622befc438464e23f7e6\",hostname=\"server-c\"} $BOOT_TIME
" > $METRICS_FILE.tmp
