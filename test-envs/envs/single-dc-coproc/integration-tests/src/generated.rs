...
async fn dns_all_servers_resolve_from_master_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ...
        ("server-e.us-west.epl-infra.net", &["10.18.0.10"]),
        ("server-f.us-west.epl-infra.net", &["10.18.0.11"]),
...
async fn dns_ptr_records_resolve_from_master_us_west() -> Result<(), Box<dyn Error>> {
    let ptr_and_dns: &[(&str, &[&str])] = &[
        ...
        ("10.0.18.10.in-addr.arpa.", &["server-e.us-west.epl-infra.net."]),
        ("11.0.18.10.in-addr.arpa.", &["server-f.us-west.epl-infra.net."]),
...
async fn docker_registry_us_west_dns_exists() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-docker-registry.service.consul", &["10.17.0.10", "10.17.0.11", "10.17.0.12", "10.17.0.13", "10.18.0.10", "10.18.0.11"]),
...
async fn external_lb_region_us_west_metrics_exist() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "nginx_http_requests_total").await?);
...
#[tokio::test]
async fn inter_dc_dc_1_to_dc_2_subnet_ping_from_10_17_0_0p24_to_10_18_0_10p32_works() -> Result<(), Box<dyn Error>> {
    let servers_and_ips: &[(&str, &[&str])] = &[
        ("10.17.0.10", &["10.18.0.10"]),
...
#[tokio::test]
async fn inter_dc_dc_2_to_dc_1_subnet_ping_from_10_18_0_10p32_to_10_17_0_0p24_works() -> Result<(), Box<dyn Error>> {
    let servers_and_ips: &[(&str, &[&str])] = &[
        ("77.77.77.14", &["10.17.0.10", "10.17.0.12"]),
...
#[tokio::test]
async fn intra_dc_dc_2_subnet_ping_from_10_18_0_10p32_to_10_18_0_11p32_works() -> Result<(), Box<dyn Error>> {
    let servers_and_ips: &[(&str, &[&str])] = &[
        ("77.77.77.14", &["10.18.0.11"]),
...
#[tokio::test]
async fn intra_dc_dc_2_subnet_ping_from_10_18_0_11p32_to_10_18_0_10p32_works() -> Result<(), Box<dyn Error>> {
    let servers_and_ips: &[(&str, &[&str])] = &[
        ("77.77.77.15", &["10.18.0.10"]),
...
async fn loki_cluster_main_reader_prometheus_metrics_exist() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "loki_querier_tail_active{job='epl-loki-main-loki-reader'}").await?);
...
async fn loki_cluster_main_writer_prometheus_metrics_exist() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "loki_distributor_ingester_appends_total{job='epl-loki-main-loki-writer'}").await?);
...
async fn minio_cluster_global_prometheus_metrics_gathered() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "minio_s3_requests_total").await?);
...
async fn monitoring_cluster_default_cadvisor_metrics_exist() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "container_cpu_user_seconds_total").await?);
...
async fn monitoring_cluster_default_dns_exists() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-mon-default-prometheus.service.consul", &["10.17.0.12", "10.17.0.13"]),
...
async fn monitoring_cluster_default_has_epl_l1_provisioning_id_metrics() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "epl_l1_provisioning_id").await?);
...
async fn monitoring_cluster_default_has_vector_metrics() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "vector_buffer_events").await?);
...
async fn monitoring_cluster_default_no_scrape_targets_are_down() -> Result<(), Box<dyn Error>> {
    assert!(!does_prometheus_metric_exist("10.17.0.12", 9090, "up == 0").await?);
...
async fn monitoring_cluster_default_node_exporter_metrics_exist() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "node_cpu_seconds_total").await?);
...
async fn monitoring_cluster_default_prometheus_metrics_exist() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "prometheus_target_scrape_pool_targets").await?);
...
#[tokio::test]
async fn nats_cluster_main_nats_instances_available_in_dns() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-nats-main-nats.service.consul", &["10.17.0.11", "10.17.0.12", "10.17.0.13"]),
...
#[tokio::test]
async fn nats_cluster_main_nats_prometheus_metrics_gathered() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "gnatsd_varz_jetstream_meta_cluster_size{job=\"epl-nats-main-nats-prom\"}").await?);

    Ok(())
}

#[tokio::test]
async fn nats_cluster_main_nats_tcp_sockets_open() -> Result<(), Box<dyn Error>> {
    let sockets = [
        "10.17.0.11:4222",
        "10.17.0.12:4222",
        "10.17.0.13:4222",
...
async fn nomad_clients_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("nomad-clients.service.consul", &["10.17.0.10", "10.17.0.11", "10.17.0.12", "10.17.0.13", "10.18.0.10", "10.18.0.11"]),
...
#[tokio::test]
async fn nomad_job_region_us_west_job_nats_main_nats_logs_in_main() -> Result<(), Box<dyn Error>> {
    assert!(check_if_loki_stream_exists("10.17.0.10:53", "epl-loki-main-loki-reader.service.consul", 3012, "{source_type=\"nomad_docker\",job_name=\"nats-main-nats\"}").await?);
...
async fn nomad_region_us_west_prometheus_metrics_gathered() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "nomad_client_allocs_cpu_allocated").await?);
...
async fn pg_deployment_testdb_db_exists_grafana() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "pg_locks_count{job='epl-pg-testdb-pg-exp',datname='grafana'}").await?);
...
async fn pg_deployment_testdb_db_exists_postgres() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "pg_locks_count{job='epl-pg-testdb-pg-exp',datname='postgres'}").await?);
...
async fn pg_deployment_testdb_prometheus_metrics_gathered() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "pg_locks_count{job='epl-pg-testdb-pg-exp'}").await?);
...
async fn vault_region_us_west_prometheus_metrics_gathered() -> Result<(), Box<dyn Error>> {
    assert!(does_prometheus_metric_exist("10.17.0.12", 9090, "vault_barrier_list_count").await?);
