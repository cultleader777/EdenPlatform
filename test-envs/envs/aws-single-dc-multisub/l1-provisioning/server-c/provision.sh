...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
guIlpBI+ozoqv6fFR6ZJ51sjr7weZ2KBoSzIyBRwpVI=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

q1T8DhkCIFcRJvAhLkRxV5hcWVZcq3L72pctHorTih2dX5SxcpHa
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIHrj0ZnPPvXN0W4AzTYLhYqXmYRZiiZtSxZC9pLQ6mZnoAoGCCqGSM49
AwEHoUQDQgAEXr4Qporg6Cg421fPAkXIxysJOwlZ5e+DjKaDPjzCgeYUHVXMTWj8
YlMa19BuYC0mK+qTmS+2j/InS7CBeajToQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSQAwRgIhANpzJIccaJDDDOIG
6eFZk/C6bazjXTmTDNmC9zRQ7D6VAiEAhd2JuIdV439IaeIlRYbBruR+WTAqol3p
Ap8DAVuASAI=
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIITxODd67RXqyytuv9XygaBV4hYwuQ2sMcs2422U5Et4oAoGCCqGSM49
AwEHoUQDQgAE3Sn0DhDdH3lfv385zHn2FGb1R/tYXj9YZ0nP5Ohjvvia7OROgtm0
Pk4jX/48RmdZHqAcDVAGtfPZJEo5Qlo+Sg==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
WEPHQqSyoFgN/z09pPhNPrtIsw4ay6xuUeOABSM+tEk=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no lWZrA7dBeSTNJ1n5ch6HpZTQBeSgYWGxCKimRzvs3n
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool minio-docker-c /srv/volumes/minio-docker-c 1M on yes iK1XBO3TxcNxs7p6rFvaTJikSRRhzUZdfy6L4t0ZID
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes ZdsbpYsSVtrgEBnZFyIxliYW7GmKOkUdX7dGCNFzpd
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes B4C0BwTW2HItCoWiTkLV2s5Bz0Q6ubjeFlFrQjIz4H
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes DNFGu9DXmM3sqFbVrc1XX22kg0YKofLDV1nvxrLYLN
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no SrZk0p7JHj8kwHMexoljThDyV5EAPskKuThc30aVnl
provision_zfs_dataset rpool vault /var/lib/vault 4k on no o5Ie1GRm7oHcWv9OBG2O2gqC6jFePRraAyIfTsaXRk
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-c.dc1.us-west.aws-single-dc-multisub:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-c.dc1.us-west.aws-single-dc-multisub: \w\a\]\u@server-c.dc1.us-west.aws-single-dc-multisub:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-c.dc1.us-west.aws-single-dc-multisub:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
# NIX REGION frr_bgp_config START
  ...
  services.frr.bgp = {
      ...
      config = ''
        !
        router bgp 64529
          bgp router-id 10.17.1.10
          address-family ipv4 unicast
            network 10.17.0.0/16
          exit-address-family
          neighbor 10.17.252.10 remote-as 64529
          neighbor 10.17.252.10 password u6XA3toUnKGejDQ8Ct9INMoI0FLZTMPgxIlsWeDMKu
          neighbor 10.17.252.10 bfd
          neighbor 10.17.252.11 remote-as 64529
          neighbor 10.17.252.11 password xnBzaJcyYSUYYxCUKlEwjyXXCJGUWDijNguiFXzpX2
          neighbor 10.17.252.11 bfd
          neighbor 10.17.252.13 remote-as 64529
          neighbor 10.17.252.13 password cj2UNksGECdcxABR5tRaKFfjNDzkFGKYotdCPeRzhk
          neighbor 10.17.252.13 bfd
          address-family ipv4 unicast
            network 10.17.0.0/16
          exit-address-family
      '';
...
# NIX REGION keepalived END
    ...
    networking.interfaces.eth1.ipv4.addresses = [
      { address = "10.17.252.12"; prefixLength = 22; }
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"cbc5ae7a6d04f086aaab7361cd5ba0fddaec02d85ab2f8c2a764cce21cfd58c1\",hostname=\"server-c\"} $BOOT_TIME
" > $METRICS_FILE.tmp
