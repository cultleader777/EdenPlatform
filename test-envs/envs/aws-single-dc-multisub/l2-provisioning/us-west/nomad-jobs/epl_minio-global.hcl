    ...
    task "minio-global-daemon" {
      ...
      config {
        ...
        args = [
          ...
          "http://10.17.1.10:9000/var/lib/minio",
          "http://10.17.1.11:9000/var/lib/minio",
        ]
        labels {
          epl_loki_cluster = "main"
        }
...
upstream minio {
    ...
    server 10.17.1.10:9000;
    server 10.17.1.11:9000;
