    ...
    task "mon-default-am" {
      ...
      config {
        ...
        args = [
          ...
          "--cluster.peer=10.17.1.10:9093",
          "--cluster.peer=10.17.1.11:9093",
        ]
      }
  ...
  group "alertmanager-2" {
    ...
    task "mon-default-am" {
      ...
      config {
        ...
        network_mode = "host"
        args = [
          "--web.listen-address=10.17.1.10:9092",
          "--config.file=/secrets/alertmanager.yml",
          "--storage.path=/volume/alertmanager",
          "--cluster.listen-address=10.17.1.10:9093",
          "--cluster.advertise-address=10.17.1.10:9093",
  ...
  group "alertmanager-3" {
    ...
    task "mon-default-am" {
      ...
      config {
        ...
        network_mode = "host"
        args = [
          "--web.listen-address=10.17.1.11:9092",
          "--config.file=/secrets/alertmanager.yml",
          "--storage.path=/volume/alertmanager",
          "--cluster.listen-address=10.17.1.11:9093",
          "--cluster.advertise-address=10.17.1.11:9093",
          "--cluster.peer=10.17.0.10:9093",
          "--cluster.peer=10.17.1.10:9093",
        ]
      }
  ...
  group "monitoring-2" {
    ...
    task "mon-default-prometheus" {
      ...
      config {
        ...
        network_mode = "host"
        args = [
          "--web.listen-address=10.17.1.10:9090",
          "--config.file=/secrets/prometheus.yml",
          "--storage.tsdb.path=/volume/prometheus-data",
          "--storage.tsdb.retention.time=15d",
          "--web.console.libraries=/opt/bitnami/prometheus/conf/console_libraries",
...
remote_write:
  - url: http://10.17.1.10:9091/api/v1/write
    ...
    task "mon-default-vm" {
      ...
      config {
        ...
        args = [
          "-storageDataPath=/volume/victoriametrics-data",
          "-retentionPeriod=24",
          "-httpListenAddr=10.17.1.10:9091",
        ]
      }
