...
consul {
    ...
    cert_file = ""
    key_file = ""
    token = "6ab6adb4-7639-461a-9cbb-0a5a17cba222"
...
client {
  ...
  meta = {
    ...
    "lock_epl-ch-keeper-server-b-testkeeper" = "1"
    "lock_epl-clickhouse-server-b-testch" = "1"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
Ky7Cd6jd23XEEjdJjrdIjJKV25KJKu190L75sgH/nIg=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

0XbcF+0CIGwLff85AoV3yOGyn2HowA+kC5noIAHT1A9GrmjBx4j7
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIBbGckccujTaok+mGujqXE8psQ8H6Oy5po38Qnazq6XioAoGCCqGSM49
AwEHoUQDQgAEeuUhnmhRI9Kwa6D7H4f2R2fqKZ5FgPmS4NvWyu5TDqXX7TaOt9HI
M9oJK+mLCLf+8vcinkkHEAyAK8zfEoMOqQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIOXX15Inyz+t1C+js+TK7Scvnt9oEX87E7sk40HKyrfeoAoGCCqGSM49
AwEHoUQDQgAEppVidbb0R1N8m8QwKNjIv+k9kWzoIs7RmF+QthlWHsp41j3KRDH8
cV9RPv27nLpdf03jHFAM5HRP4K5PpNPR+A==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDRwAwRAIgN9WaG35DYU2rwq8f
5YFhpVrIDsIS/Ms9DHbf7nWUyjoCIH14pdNYMNYrrJGcB7wWyz1fqvc2B016V32i
7eg8wW41
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIPuvT0lvLH+arIwh8pGfkbh8xrcU4IwbDdkrAI4oE77AoAoGCCqGSM49
AwEHoUQDQgAEoHk5N/rmQG4PL8bh/eHg1yPN8R0YtC/VpMqONZOXjikt53rwsbqD
Opkm9PF0vOPV2K/oAB0fhk522njhP7ZOvQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool ch-keeper /srv/volumes/ch-keeper 4k on yes bNQZI47CaRUOp8eWCspsS8cD1Yh7uaamhU5wYmCKxQ
provision_zfs_dataset rpool clickhouse /srv/volumes/clickhouse 4k on yes 0l4KYwXeQ3axLmVkojvIOYXLsJrd9WhBNYaX00t9KD
provision_zfs_dataset rpool consul /var/lib/consul 4k on no rYEn7cZRvTcqPQqAP4jB79LmWdLMepMtD0Qw189vl5
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes lAaHFX3abfw6qLst6I9LVtfNG6pWbvVwldMn9ApjXp
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes J0ntH2bLRoIsm6vSDUsSLyV50pMjHHGjIozKNv3Ke4
provision_zfs_dataset rpool vault /var/lib/vault 4k on no yAMf3wgDTj1xjFHdRoSc8F6yIjIe4P4KgkY0T8RYdN
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"463ab38a64a6a536c117289d64c41d916096874ceee7f97bd03bc1a4463cbb5e\",hostname=\"server-b\"} $BOOT_TIME
" > $METRICS_FILE.tmp
