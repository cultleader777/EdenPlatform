...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
{
  "acl": {
    ...
    "tokens": {
      ...
      "initial_management": "a25ec854-6f9e-40fb-9c06-457447d32112"
    }
  },
  "addresses": {
    "dns": "127.0.0.1",
...
client {
  ...
  meta = {
    ...
    "lock_epl-ch-keeper-server-a-testkeeper" = "1"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
SPFHjPARnKhQENojDRFacSvaim5qLulWurKodjwCFjQ=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIKFrW9V+GoFXHMclOQovdaLVvw5hhg4B5EALf294Wza7oAoGCCqGSM49
AwEHoUQDQgAEZIyVbEVjWwwWZzup9rqDOydCOB1WenmTPMdZBSWgM4lTW0L2F1Q7
WazvHJJpDLRwO+3msrH+6k0la3A/dSXyHQ==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
a25ec854-6f9e-40fb-9c06-457447d32112
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
4d4d8e2c-d34e-49fe-8660-e8219c518954
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
c296ef25-babe-4f1c-9855-ead204f92c11
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
17ff7f29-5d35-4a0b-bf56-90376532f8ba
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
6ab16864-c1dd-49fb-a497-6d625792b339
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
6ab6adb4-7639-461a-9cbb-0a5a17cba222
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
c3Vsgglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIhAJso98kM9ytu
2MwnBQOZrJuBuluDyIt3v4DwjsygRNsCAiByao9nS8QCdIruHOWJyQKPW2TQyVxY
IrSoY5w8F7WCQg==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIDgX56XXXtPKZ2gxJRUKtB9okL4GwcNDadHYcM4LwxeXoAoGCCqGSM49
AwEHoUQDQgAEw2vnq1aKDm7yvtypunsobvhpxJ4QPphLHuIQ1k8tddmhaxfbkj32
4masJkjuObkBETjsCbbibDwXlQEd4PtBsA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

cx6gxc4lIXZe5Q/rXMNVYFataWPQ
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIDb2EIsEvq+W9i4cnERioQOKJCIJCaEUcLqEHU3j6UUvoAoGCCqGSM49
AwEHoUQDQgAEPXCk/wWyqkLNJJ91cAja7mvyUpVzUiJ/B6XNkWysqMRQ1+DS5oCI
oX4usJ4JgCMz46eqTbUgpdgoZ2DCbklaqA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
04716568-3a16-4f1b-b391-d6da4d3f167a
LilBoiPeepLikesBenzTruck
...
provision_zfs_dataset extra bigone /srv/volumes/bigone 4k on yes Drgfm2HsjAgeQE7hEGABtKNBPXlBEag5MLkx4BhowG
provision_zfs_dataset rpool ch-keeper /srv/volumes/ch-keeper 4k on yes xcDWWUzYr6OVJxBKn9SukmYmBEzdiKElGkOkNR1wpP
provision_zfs_dataset rpool consul /var/lib/consul 4k on no 8QQELMGo82hHHiDcyfJx2y6DGrsXGLWZyWBKEPRzVI
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes 3zk4YqjdSgJ17n62GUcz1rDo6HLaT7Ps1rfFY8phEX
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes wlvsasEh7WbHI8dCahDH5vqoxILjPqDaGwfOh39EiS
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no kYQvLU2DcEH7Imv8jdAwl5QY0M1Zz8wImrfefQ1fHe
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes KTgegFRY8KkOuKDMLtQmOhmsScbICyyMvZXcEATc0e
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"78799a9cdfa510bb5779ccbe2a7536f45c9aba5c32c0fd14386183ddfc829a44\",hostname=\"server-a\"} $BOOT_TIME
" > $METRICS_FILE.tmp
  ...
  echo '
epl_l1_provisioning_expected_hash{hash="78799a9cdfa510bb5779ccbe2a7536f45c9aba5c32c0fd14386183ddfc829a44",hostname="server-a"} 1
epl_l1_provisioning_expected_hash{hash="463ab38a64a6a536c117289d64c41d916096874ceee7f97bd03bc1a4463cbb5e",hostname="server-b"} 1
epl_l1_provisioning_expected_hash{hash="486866096a171adb32e1cc208fea63e00a527b719575716ac979a65ad3e3f05e",hostname="server-c"} 1
epl_l1_provisioning_expected_hash{hash="df98043e68b65c7c7bc134a7b3d5527957c8ff98d66553668213681f83dda53c",hostname="server-d"} 1
