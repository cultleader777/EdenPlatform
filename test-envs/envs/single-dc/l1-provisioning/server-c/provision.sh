...
client {
  ...
  meta = {
    ...
    "lock_epl-clickhouse-server-c-testch" = "1"
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
kghxcUEuTsHavZ0F/iB4njXOwRsnV6nH8gQoOGrosAc=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIOP18mt5zrlDmUyKiOKaSq0INt8pZLDRMpkrn3J4BvB4oAoGCCqGSM49
AwEHoUQDQgAEskRC3/1kh+Fpos3XTa0C19MWKWPQ3zg24DLyX1S7uJECyHskwYmI
I8ZK2QStahpmJLlYxL65L6D5nqaE6CoqOg==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDRwAwRAIgRIgHMiRMMlT9uJBz
VZ4EDFrDrzyNZugJ/BU69zYh7g4CIBgnN8YnBcx55FZkXxo3V256/cy2+Q2X8wAK
rhoqr9lf
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIGBnMyO+S29gu6/2c7iXJAlTHrR27KFo8h93xey93j0coAoGCCqGSM49
AwEHoUQDQgAEwmhqtQOM3LvWmjHJ6QcWD6yRLvw+xdZzk5wgdoO1XmDKocma4VyX
0T51H07pA4nf4S9tG4dXyVXQDVtq60YY8Q==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
cCH98qQfXtGVM4/+oKCXk/SzWMeqxKRd+50jL1V1bFA=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool clickhouse /srv/volumes/clickhouse 4k on yes foIzd8WuB9TVIqJyASnKBKOMsrPSo8gwuJxVMJgyxr
provision_zfs_dataset rpool consul /var/lib/consul 4k on no Gg7fyWgSf416c11pvhAOcdMSHwkjfIKr1DFbR3Bb9h
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes MSbArS1NDGA8n6EY9diVGhDaeEUgwuxioNKvCPdvEs
provision_zfs_dataset rpool mon-default /srv/volumes/mon-default 4k on yes iy3db8b0tsSm0DSWLUlgxHX28Qucnl28Ce3eyvaMbP
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes qf8RvqLqrlIp0dXFryktz3mCP0OmatTp4FTSSnYW2C
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no VAsL0oyhxPxPxZfV5liMAckl8iqGwYrI3lW5MDJxEI
provision_zfs_dataset rpool pgtest1 /srv/volumes/pgtest1 4k on yes GuJ4WxcTvP5bLZ7ciBfkATzEs36Eb1mEE1iXgPjV07
provision_zfs_dataset rpool vault /var/lib/vault 4k on no uKICMnTcrCNpEvtzbK7tFBgM7rlfpRii5bnJDUs0jF
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"486866096a171adb32e1cc208fea63e00a527b719575716ac979a65ad3e3f05e\",hostname=\"server-c\"} $BOOT_TIME
" > $METRICS_FILE.tmp
