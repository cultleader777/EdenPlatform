...
async fn dns_ns_records_resolve_to_ips_in_master_servers_epl_infra_net() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("ns1.epl-infra.net", &["77.77.77.14"]),
        ("ns2.epl-infra.net", &["77.77.77.11"]),
        ("ns3.epl-infra.net", &["77.77.77.12"]),
...
async fn dns_ns_servers_resolve_from_all_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("ns1.us-west.epl-infra.net", &["10.19.0.10"]),
        ("ns2.us-west.epl-infra.net", &["10.17.0.11"]),
        ("ns3.us-west.epl-infra.net", &["10.18.0.10"]),
...
async fn dns_ptr_records_resolve_from_master_us_west() -> Result<(), Box<dyn Error>> {
    let ptr_and_dns: &[(&str, &[&str])] = &[
        ...
        ("11.0.17.10.in-addr.arpa.", &["ns2.us-west.epl-infra.net."]),
        ("10.0.18.10.in-addr.arpa.", &["ns3.us-west.epl-infra.net."]),
        ("11.0.18.10.in-addr.arpa.", &["server-d.us-west.epl-infra.net."]),
        ("10.0.19.10.in-addr.arpa.", &["ns1.us-west.epl-infra.net."]),
...
async fn dns_root_servers_resolve_from_master_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("ns1.epl-infra.net", &["10.19.0.10"]),
        ("ns2.epl-infra.net", &["10.17.0.11"]),
        ("ns3.epl-infra.net", &["10.18.0.10"]),
...
async fn docker_registry_us_west_dns_exists() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-docker-registry.service.consul", &["10.17.0.10", "10.17.0.11", "10.18.0.10", "10.18.0.11", "10.19.0.10", "10.19.0.11"]),
...
async fn minio_cluster_global_instances_available_in_dns() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-minio-global.service.consul", &["10.17.0.10", "10.17.0.11", "10.18.0.10", "10.19.0.10"]),
...
async fn monitoring_cluster_default_dns_exists() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("epl-mon-default-prometheus.service.consul", &["10.17.0.10", "10.18.0.11"]),
...
async fn nomad_clients_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("nomad-clients.service.consul", &["10.17.0.10", "10.17.0.11", "10.18.0.10", "10.18.0.11", "10.19.0.10", "10.19.0.11"]),
...
async fn nomad_servers_available_from_region_us_west_to_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("nomad-servers.service.us-west.consul", &["10.17.0.11", "10.18.0.11", "10.19.0.11"]),
...
async fn nomad_servers_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("nomad-servers.service.consul", &["10.17.0.11", "10.18.0.11", "10.19.0.11"]),
...
async fn vault_servers_available_from_region_us_west_to_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("vault.service.us-west.consul", &["10.17.0.11", "10.18.0.10", "10.19.0.11"]),
...
async fn vault_servers_available_region_us_west() -> Result<(), Box<dyn Error>> {
    let ips_and_dns: &[(&str, &[&str])] = &[
        ("vault.service.consul", &["10.17.0.11", "10.18.0.10", "10.19.0.11"]),
