...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
SH5AfNMH3SKB0smxvK+GCf8jw7weLa5Xvl6M9Ab2M9s=
LilBoiPeepLikesBenzTruck
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"5aec7beb1875ece6913e388ac36a098487ed348f2ed996611ca5a3af321389e2\",hostname=\"server-i\"} $BOOT_TIME
" > $METRICS_FILE.tmp
