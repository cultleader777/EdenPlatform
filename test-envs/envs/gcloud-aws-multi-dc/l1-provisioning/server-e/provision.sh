...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
byxSoCzWm2ksJ+C1jLLx6aXefHz9Iu+UNOi9ztYGHjo=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----
MIICxDCCAmqgAwIBAgIQKHCMumhPQwp/ELNNqsxTPTAKBggqhkjOPQQDAjCBuTEL
...

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEINWcowjHOlwV9qvSRXBQRobbUYvesUvPDDOQuHoIe2tNoAoGCCqGSM49
AwEHoUQDQgAE05MOnh+9ZVMesmmRLy3mc68gBVWDzBTlcfxuxXx/57H2TYFUHqLI
0MwOvkCBPvTZJLLcsBJ2GekDowM8I3wAJA==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
sBj9KFjqiA+cltslGLlhykBsD5mN3yUKLOiJQoLavXw=
LilBoiPeepLikesBenzTruck
...
zpool import -af
provision_zfs_dataset rpool consul /var/lib/consul 4k on no j7jwWYVTizFpxsyC8OFzZPl7PBeU5YgIVNFzfB9MW0
provision_zfs_dataset rpool docker /var/lib/docker 128k on no
provision_zfs_dataset rpool minio-docker-e /srv/volumes/minio-docker-e 1M on yes kuEJvvpbUIAkzwCZ4MQMcihqLPhVXTKdhD5JfEPNdQ
provision_zfs_dataset rpool mon-am /srv/volumes/mon-am 4k on yes jGNEChzN3WO8pR3KefxsJD7FI6F6Epn0NLbjK7UHKQ
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes KbIpWvGl76A2OBxEiMcojmsfk6U9JNhYZu5ZeNR2Sb
...
wg set wg0 peer "lpKHmY1L/Gdf9qt/AoNKKMeABu6e9X5orK2/2M93bAU=" allowed-ips "172.21.7.10/32,10.17.0.0/16" endpoint "34.102.96.253:51820"

wg set wg0 peer "MnRggErXM8TnEkmzbCBTKHoZUh4+Y6Pd5cwHwD/X6Hg=" allowed-ips "172.21.7.12/32,10.18.0.0/16" endpoint "34.102.72.86:51820"
  ...
  services.frr.bgp = {
      ...
      config = ''
        ...
        router bgp 64531
          ...
          neighbor 10.19.0.11 password wTmvlUuORgR3ITgkN8rgak1Ul9s5iu2ANCqxh3yLTM
          neighbor 10.19.0.11 bfd
          neighbor 172.21.7.10 remote-as 64529
          neighbor 172.21.7.10 password 8qQnHNEwniC6s7xxZxtUZIsORr2sxlRQkeHct2SEfm
          neighbor 172.21.7.10 bfd
          neighbor 172.21.7.12 remote-as 64530
          neighbor 172.21.7.12 password b7GfdEeBEALUbhmVY9A1IetEqRAa5DwQX2D5MuzPqq
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"60c573b430e3e469582d95b75b1b7b4152faa7cc66dc26ffcff4611c07e94529\",hostname=\"server-e\"} $BOOT_TIME
" > $METRICS_FILE.tmp
