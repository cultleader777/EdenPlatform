...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
bEro/1mc4RHWY5Ca7jtL7pDlxKUK9iTMAqWdSrkmmK4=
LilBoiPeepLikesBenzTruck
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"36a87b22ccbb5c185fbd90da88738d49dd6adac112ec37fa9bb8a01779ec2e4e\",hostname=\"server-g\"} $BOOT_TIME
" > $METRICS_FILE.tmp
