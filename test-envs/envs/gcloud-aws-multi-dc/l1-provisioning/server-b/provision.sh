...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
1u1Oel5OCe55DtQVfQTSWQ2u2ATbtVKmzz4nCx76+H8=
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
c3Vsgglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIhAMhHO2IrDeK8
hWMgtMtVvWQ15QjTOCiu73CY5DMhwtKcAiA0899vphCfWYWhUeSui19CWwMUY88L
N8cfwuwP4jtoSA==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIFrYVitWPHHdNGRAETQgpKn40wCnf0zbDu98xgLvjzk7oAoGCCqGSM49
AwEHoUQDQgAEMr+G7pq1k87Kcz2+jY7zUAmwr5qw6UoqmBT+pQiRPpD0zJIwA1dc
AaWIhV+rgvmTh8btEIx+61VaAOlhIdM9gw==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEICWyjbkkaEUBpmu81Chb5URjf+K88MFwWDjtOkmESoatoAoGCCqGSM49
AwEHoUQDQgAEajtei+sj+/IpQrMMOf6Q4pAoN+VSx6mTcrJJGCKPeTEvOsG3Ub99
cES0cey+oTvtQAOstB/bPiXNlmcqxa8nqg==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN CERTIFICATE-----

...
gglsb2NhbGhvc3SHBH8AAAEwCgYIKoZIzj0EAwIDSAAwRQIgUXPVeUTa3SZX7l/w
jWIHd8iyj5gUeuMVRQRYBjRqKycCIQD2TArMwGH41T4QkIxxMkaQlwQvh8XNKFla
njs1ckey0g==
-----END CERTIFICATE-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIJQn9m6s50t+7V7tvs7x8xYYpsDWYSTr+mUS121Pu//KoAoGCCqGSM49
AwEHoUQDQgAErCDwlqEnltlhbgLsDkd3N2ixptcgnj6l3d7iob0Hyjaa+sXhOkV0
fouFh8sW6aEO6dochW1ZgOFJIMTz03wRPw==
-----END EC PRIVATE KEY-----
LilBoiPeepLikesBenzTruck
...
cat > $TMP_SECRET_PATH <<'LilBoiPeepLikesBenzTruck'
UBCOGqOj42vy0zQw5R0X2OVZOBuqZen6UX7rXfuPKUo=
LilBoiPeepLikesBenzTruck
...
provision_zfs_dataset rpool minio-docker-b /srv/volumes/minio-docker-b 1M on yes Kba5AjS59Q83Gem4rSeRuPzhr1uUnFuXLI5lLfxihy
provision_zfs_dataset rpool nats1 /srv/volumes/nats1 4k on yes lL8OLL6ngBwKcocO4NKFeiC7PBlKu3hGn7VATVKJRl
provision_zfs_dataset rpool nomad /var/lib/nomad 4k on no tQ66TzndvD0d3SrCkI4kWUdFS7IUCdUMUHxoBiY0rd
provision_zfs_dataset rpool vault /var/lib/vault 4k on no blr0TEqNiCHZxOsIM1LuyK4NKyUXSD8yqRP1kqA81u
...
# ROUTES CREATE
ip route add 10.19.0.0/16 via 10.17.128.11
...
# NIX REGION epl_nft_rules_epl-internet-fw START
       ...
       chain EPL_INTERNET_FIREWALL {
           ...
           iifname void ip saddr != { 10.0.0.0/8, 172.21.0.0/16 } ip daddr != { 34.94.176.250/32 } drop comment "Disallow traffic from internet to internal networks";
       }
   ...
   programs.bash.promptInit = ''
     ...
     if [ "$TERM" != "dumb" ] || [ -n "$INSIDE_EMACS" ]; then
       ...
       if [ -n "$INSIDE_EMACS" ]; then
         ...
         PS1="\n\[\033[$PROMPT_COLOR\][\u@server-b.dc1.us-west.gcloud-aws-multi-dc:\w]\\$\[\033[0m\] "
       else
         PS1="\n\[\033[$PROMPT_COLOR\][\[\e]0;\u@server-b.dc1.us-west.gcloud-aws-multi-dc: \w\a\]\u@server-b.dc1.us-west.gcloud-aws-multi-dc:\w]\\$\[\033[0m\] "
       fi
       if test "$TERM" = "xterm"; then
         PS1="\[\033]2;server-b.dc1.us-west.gcloud-aws-multi-dc:\u:\w\007\]$PS1"
       fi
     fi
   '';
...
# NIX REGION l3_vpn_hop_interface START
  ...
  systemd.services.vpn-gre-tunnel = {
    ...
    script = ''
        ip tunnel add vpnGre mode gre local 10.17.0.11 key 17
        ip addr add 10.17.128.11/17 dev vpnGre
...
# NIX REGION frr_bgp_config START
  ...
  services.frr.bgp = {
      ...
      config = ''
        !
        router bgp 64529
          bgp router-id 10.17.0.11
          address-family ipv4 unicast
            network 10.17.0.0/16
          exit-address-family
          neighbor 10.17.0.10 remote-as 64529
          neighbor 10.17.0.10 password QscXui9VQNfFsi0Omz9X4CX1MS4Y7SSjzCwoEQ6uuf
          neighbor 10.17.0.10 bfd
          neighbor 172.21.7.13 remote-as 64530
          neighbor 172.21.7.13 password yqPdL0hE0M5p2LesNMCSb8KAIJHsmygEltZ0uJghMl
          neighbor 172.21.7.13 bfd
          neighbor 172.21.7.15 remote-as 64531
          neighbor 172.21.7.15 password 9t0v3GkWlaZ0FuO9u96H0DQt1Uc27Nt6SxGdUoQurL
...
then
  ...
  echo "
epl_l1_provisioning_last_hash{hash=\"cd92848cd80cfc3aee9f1ad5c1c5968e5158494e7a163310fe47ebd08fd56e12\",hostname=\"server-b\"} $BOOT_TIME
" > $METRICS_FILE.tmp
