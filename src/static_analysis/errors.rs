...
pub enum PlatformValidationError {
    ...
    PublicIpV6AddressDoesNotEndWithOne {
        server_name: String,
        ipv6_address: String,
    },
    ...
    VlanIdForInterfaceIsInInvalidRange {
        server_name: String,
        interface_network: String,
        interface_name: String,
        interface_ip: String,
    ...
    VlanIdForRouterSubnetIsInInvalidRange {
        min_vlan: i64,
        max_vlan: i64,
        router_subnet_vlan_id: i64,
        datacenter_implementation: String,
    },
    VlanDisabledInDcImplementationButSpecified {
        server_name: String,
        interface_network: String,
        interface_name: String,
        interface_ip: String,
    ...
    VlanSubnetRouterVlanIdUnspecified {
        subnet_count: usize,
        vlan_id: i64,
        datacenter_implementation: String,
    },
    VlanSubnetRouterVlanIdSpecifiedButNotUsed {
        subnet_count: usize,
        vlan_id: i64,
        datacenter_implementation: String,
    },
    VlanSubnetRouterVlanIdClashesWithSubnetVlanId {
        subnet_count: usize,
        router_subnet_vlan_id: i64,
        subnet_vlan_id: i64,
        subnet: String,
    ...
    VlanInvalidInterfaceName {
        server_name: String,
        interface_network: String,
        interface_name: String,
        interface_ip: String,
        vlan_id: i64,
        example_valid_interface_name: String,
        datacenter_implementation: String,
    },
    VlanInterfaceNameIdIsNotANumber {
        server_name: String,
        interface_network: String,
        interface_name: String,
        interface_ip: String,
    ...
    VlanInterfaceNameIdMismatchToVlanId {
        server_name: String,
        interface_network: String,
        interface_name: String,
        interface_ip: String,
        interface_vlan: i64,
        interface_name_vlan_id: i64,
        example_valid_interface_name: String,
        datacenter_implementation: String,
    },
    VlanCantFindVlanParentNetworkInterface {
        server_name: String,
        interface_network: String,
        interface_name: String,
        interface_ip: String,
        interface_vlan: i64,
        interfaces_on_server: Vec<String>,
        example_valid_interface_name: String,
        datacenter_implementation: String,
    },
    HetznerInterDcVlanIdClashesWithSubnetVlanIds {
        interface_vlan: i64,
        hetzner_inter_dc_vlan_id: i64,
        datacenter_implementation: String,
    },
    ...
    BlackboxDeploymentEnvironmentVariableNameIsInvalid {
        bb_deployment: String,
        bb_region: String,
        group_name: String,
        task_name: String,
    ...
    BlackboxDeploymentRawValueOrValueSourceMustBeNotEmpty {
        bb_deployment: String,
        bb_region: String,
        group_name: String,
        task_name: String,
    ...
    BlackboxDeploymentRawValueAndValueSourceAreMutuallyExclusive {
        bb_deployment: String,
        bb_region: String,
        group_name: String,
        task_name: String,
    ...
    BlackboxDeploymentValueSourceNotFoundInRegion {
        bb_deployment: String,
        bb_region: String,
        group_name: String,
        task_name: String,
    ...
    BlackboxIngressPortInvalidProtocol {
        bb_deployment: String,
        port: i64,
        protocol: String,
        expected_protocol: String,
    },
    BlackboxIngressPortNotFound {
        ingress_tld: String,
